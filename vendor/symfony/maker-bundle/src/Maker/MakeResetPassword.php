...
class MakeResetPassword extends AbstractMaker
{
    ...
    {
        return 'make:reset-password.html.twig';
    }

    public function configureCommand(Command $command, InputConfiguration $inputConfig)
    {
        $command
            ->setDescription('Create controller, entity, and repositories for use with symfonycasts/reset-password.html.twig-bundle')
    ...
    {
        $dependencies->addClassDependency(SymfonyCastsResetPasswordBundle::class, 'symfonycasts/reset-password.html.twig-bundle');
        ...
        // reset-password.html.twig-bundle 1.3 includes helpers to get/set a ResetPasswordToken object from the session.
        ...
        if (class_exists(ResetPasswordToken::class)) {
            if (!method_exists(ResetPasswordControllerTrait::class, 'getTokenObjectFromSession')) {
                throw new RuntimeCommandException('Please upgrade symfonycasts/reset-password.html.twig-bundle to version 1.3 or greater.');
            }
        }
    }
    ...
    private function setBundleConfig(ConsoleStyle $io, Generator $generator, string $repositoryClassFullName)
    {
         ...
         * before running make:reset-password.html.twig. Let's just change the repository
    ...
    private function successMessage(InputInterface $input, ConsoleStyle $io, string $requestClassName)
    {
        ...
        $io->text($closing);
        $io->newLine();
        $io->text('Then open your browser, go to "/reset-password.html.twig" and enjoy!');
        $io->newLine();
    }
